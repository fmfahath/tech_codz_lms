...
const SearchBar = () => {
    ...
    return (
        <form className='w-full md:w-auto my-2 ' onSubmit={handleSubmit}>
            <div className='w-full md:max-w-[500px] flex items-center md:justify-between gap-2 border border-gray-300 rounded py-1 px-2 mx-auto bg-transparent'>
                ...
                <button className='py-2 px-3 md:px-6 btn-bg text-white rounded-sm cursor-pointer shrink-0' type='submit'>Search</button>
            </div>
        </form>
    )
}
